...
namespace SistemaDeGerenciamento2_0.Context
{
    public partial class SistemaDeGerenciamento2_0Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                string stringConexao = CaminhoArquivoConexao();
        ...
        private string CaminhoArquivoConexao() 
        {

            string caminho = @"C:\Users\israe\source\repos\SistemaDeGerenciamento2_0\SistemaDeGerenciamento2_0\LogConexaoBanco.txt";


            List<string> dadosConexao = System.IO.File.ReadAllLines(caminho).ToList();


            string nomeServidor = dadosConexao[0].Split('=')[1].Replace("\\\\","\\") ;
            string banco = dadosConexao[1].Split('=')[1];
            string login = dadosConexao[2].Split('=')[1];
            string senha = dadosConexao[3].Split('=')[1];


            string stringConexao = $"Data Source={nomeServidor};Initial Catalog={banco};Persist Security Info=True;User ID={login};Password={senha}";
        ...
        private void Conexa()
        {
            ...
            string a = "Data Source=ISRAEL\\SQLEXPRESS;Initial Catalog=SistemaDeGerenciamento2_0;Persist Security Info=True;User ID=sa;Password=12345";
        }
