...
namespace SistemaDeGerenciamento2_0
{
    ...
    public partial class SistemaDeGerenciamento2_0Entities3 : DbContext
    {
        public SistemaDeGerenciamento2_0Entities3()
            : base("name=SistemaDeGerenciamento2_0Entities3")
        {
        }
        ...
        public virtual DbSet<tb_configuração_financeira> tb_configuração_financeira { get; set; }
        public virtual DbSet<tb_despesa> tb_despesa { get; set; }
        public virtual DbSet<tb_endereços> tb_endereços { get; set; }
        public virtual DbSet<tb_estoque> tb_estoque { get; set; }
        public virtual DbSet<tb_grupo> tb_grupo { get; set; }
        public virtual DbSet<tb_informações_comeciais> tb_informações_comeciais { get; set; }
