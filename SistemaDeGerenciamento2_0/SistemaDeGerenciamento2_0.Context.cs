...
namespace SistemaDeGerenciamento2_0
{
    ...
    public partial class SistemaDeGerenciamento2_0Entities5 : DbContext
    {
        public SistemaDeGerenciamento2_0Entities5()
            : base("name=SistemaDeGerenciamento2_0Entities5")
        {
        }
